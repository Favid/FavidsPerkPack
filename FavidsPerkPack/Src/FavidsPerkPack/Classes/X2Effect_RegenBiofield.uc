class X2Effect_RegenBiofield extends X2Effect_Persistent; // TODO personal config values
...
function bool IsEffectCurrentlyRelevant(XComGameState_Effect EffectGameState, XComGameState_Unit TargetUnit)
{
	...
	if (SourceUnit == none || SourceUnit.IsDead() || TargetUnit == none || TargetUnit.IsDead() || TargetUnit.GetCurrentStat(eStat_HP) >= TargetUnit.GetMaxStat(eStat_HP))
		return false;
