...
simulated protected function OnEffectAdded(const out EffectAppliedData ApplyEffectParameters, XComGameState_BaseObject kNewTargetState, XComGameState NewGameState, XComGameState_Effect NewEffectState)
{
	...
	local XComGameState_Effect_ReadyForAnything ReadyForAnythingEffectState;
	...
	if (GetReadyForAnythingComponent(NewEffectState) == none)
	{
		...
		ReadyForAnythingEffectState = XComGameState_Effect_ReadyForAnything(NewGameState.CreateStateObject(class'XComGameState_Effect_ReadyForAnything'));
...
static function XComGameState_Effect_ReadyForAnything GetReadyForAnythingComponent(XComGameState_Effect Effect)
{
    if (Effect != none) 
        return XComGameState_Effect_ReadyForAnything(Effect.FindComponentObject(class'XComGameState_Effect_ReadyForAnything'));
    return none;
}
