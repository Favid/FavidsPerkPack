class X2TargetingMethod_SabotRound extends X2TargetingMethod;
...
function Update(float DeltaTime)
{
	...
	if (NewTargetLocation != CachedTargetLocation)
	{
		...
		X2AbilityMultiTargetStyle_SabotRound(Ability.GetMyTemplate().AbilityMultiTargetStyle).UpdateSightRangeLimited(Ability);
